...
const AddEventSidebar = props => {
    ...
    const RenderSidebarFooter = () => {
        if (store.selectedEvent === null || (store.selectedEvent !== null && !store.selectedEvent.title.length)) {
            return (
                <Fragment>
                    <Button style={{ fontFamily: 'inherit' }} size='large' type='submit' variant='contained' sx={{ mr: 4 }}>
                        افزودن
                    </Button>
                    <Button size='large' variant='outlined' style={{ fontFamily: 'inherit' }} color='secondary' onClick={resetToEmptyValues}>
                        لغو
                    </Button>
                </Fragment>
            )
            ...
            return (
                <Fragment>
                    ...
                    <Button size='large' variant='outlined' style={{ fontFamily: 'inherit' }} color='secondary' onClick={resetToStoredValues}>
                        لغو
                    </Button>
                </Fragment>
            )
        ...
        >
            ...
            >
                <Typography variant='h6'>
                    {store.selectedEvent !== null && store.selectedEvent.title.length ? 'تغییر رویداد' : 'افزودن رویداد'}
                </Typography>
