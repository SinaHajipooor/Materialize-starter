...
const steps = [
    {
        title: 'اطلاعات حساب',
        subtitle: 'اطلاعات حساب خود را وارد کنید'
    },
    {
        title: 'اطلاعات شخصی',
        subtitle: 'اطلاعات شخصی خود را وارد کنید'
    },
    {
        title: 'اطلاعات شناسنامه‌ای',
        subtitle: 'اطلاعات شناسنامه‌ای خود را وارد کنید'
    }
]
                ...
                return (
                    <form key={1} onSubmit={handlePersonalSubmit(onSubmit)}>
                        <Grid container spacing={5}>
                            ...
                            <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'space-between' }}>
                                <Button sx={{ fontFamily: 'inherit' }} size='large' variant='outlined' color='secondary' onClick={handleBack}>
                                    برگشت
                                </Button>
                                <Button sx={{ fontFamily: 'inherit' }} size='large' type='submit' variant='contained'>
                                    بعدی
